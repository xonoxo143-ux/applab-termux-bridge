...
enum class BridgeAction(
    ...
    UPDATE_DISPATCHER("update_dispatcher", "Update Dispatcher from GitHub", BridgeSection.SETUP, "update_dispatcher.txt"),
    ...
    SHOW_ACTIVE_REPO("show_active_repo", "Show Active Repo", BridgeSection.REPO, "show_active_repo.txt"),
    SET_ACTIVE_LIBRESEED("set_active_libreseed", "Use LibreSeed Repo", BridgeSection.REPO, "set_active_libreseed.txt"),
    SET_ACTIVE_BRIDGE("set_active_bridge", "Use Bridge Repo", BridgeSection.REPO, "set_active_bridge.txt"),
