...
enum class BridgeAction(
    ...
    LIST_PROJECTS("list_projects", "Find Repos", BridgeSection.REPO, "list_projects.txt"),
    SELECT_CONFIGURED_REPO("select_configured_repo", "Choose Repo", BridgeSection.REPO, "select_configured_repo.txt"),
    ...
    SHOW_STATUS("show_status", "Check Repo", BridgeSection.REPO, "show_status.txt"),
    FETCH_REPO("fetch_repo", "Fetch Remotes", BridgeSection.REPO, "fetch_repo.txt"),
    PULL_CURRENT("pull_current", "Update Repo", BridgeSection.REPO, "pull_current.txt"),
    ...
    LIST_CHANGED_FILES("list_changed_files", "View Changes", BridgeSection.REPO, "list_changed_files.txt"),
