...
actions = [
    ...
    action("list_projects", "Find Repos", "Repo Workbench", "List git repositories found under the Termux projects folder.", sort=10),
    action("select_configured_repo", "Choose Repo", "Repo Workbench", "Select the repo path written by the Android chooser.", risk="mutating", sort=15),
    action("clone_bridge", "Clone Bridge Repo", "Repo Workbench", "Clone or repair the AppLab Bridge repo under ~/projects.", risk="mutating", visible=False, advanced=True, confirm=True, requires_network=True, sort=20),
    action("clone_libreseed", "Clone LibreSeed Repo", "Repo Workbench", "Clone or repair the LibreSeed repo under ~/projects.", risk="mutating", visible=False, advanced=True, confirm=True, requires_network=True, sort=30),
    action("show_active_repo", "Show Selected Repo", "Repo Workbench", "Show the configured and resolved active repo.", visible=False, advanced=True, sort=40),
    action("set_active_bridge", "Select Bridge Repo", "Repo Workbench", "Set AppLab Bridge as the active repo.", risk="mutating", visible=False, advanced=True, confirm=False, sort=50),
    action("set_active_libreseed", "Select LibreSeed Repo", "Repo Workbench", "Set LibreSeed as the active repo.", risk="mutating", visible=False, advanced=True, confirm=False, sort=60),
    action("check_repo", "Check Repo", "Repo Workbench", "Run git status for the selected repo.", requires_repo=True, sort=70),
    action("show_status", "Check Repo", "Repo Workbench", "Show branch and full git status for the selected repo.", requires_repo=True, visible=False, advanced=True, sort=80),
    action("fetch_repo", "Fetch Remotes", "Repo Workbench", "Fetch remotes and prune stale refs.", risk="network", requires_repo=True, requires_network=True, visible=False, advanced=True, sort=90),
    action("pull_current", "Update Repo", "Repo Workbench", "Pull the current branch with fast-forward only.", risk="mutating", requires_repo=True, requires_network=True, confirm=True, sort=100),
    action("show_branches", "List Branches", "Repo Workbench", "Show local and remote branches.", requires_repo=True, visible=False, advanced=True, sort=110),
    action("checkout_staging", "Checkout Staging Branch", "Repo Workbench", "Switch the selected repo to staging.", risk="mutating", requires_repo=True, requires_clean_tree=True, visible=False, advanced=True, confirm=True, sort=120),
    action("pull_staging", "Checkout + Pull Staging", "Repo Workbench", "Switch to staging and pull fast-forward only.", risk="mutating", requires_repo=True, requires_clean_tree=True, requires_network=True, visible=False, advanced=True, confirm=True, sort=130),
    action("show_current_commit", "Show Current Commit", "Repo Workbench", "Show current branch and latest commit.", requires_repo=True, visible=False, advanced=True, sort=140),
    action("list_changed_files", "View Changes", "Repo Workbench", "List changed and diffed files.", requires_repo=True, sort=150),
    action("show_diff_summary", "Show Diff Summary", "Repo Workbench", "Show diff stat and diff check output.", requires_repo=True, visible=False, advanced=True, sort=160),
    action("show_full_diff", "Write Full Diff Report", "Repo Workbench", "Write a full diff report for review.", requires_repo=True, visible=False, advanced=True, sort=170),
